...
<body>
    ...
    <div class="registerForm">
        <form action="<c:url value='/signup/professor' />" method="post">
            <div class="register-box">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="professorId" name="professorId" placeholder="교수 번호를 입력하세요" required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="professorOffice" name="professorOffice" placeholder="연구실 위치를 입력하세요" required>
                </div>
