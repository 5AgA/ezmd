...
public class InterviewDTO {
	...
	public InterviewDTO() {}
	// 모든 필드를 포함한 생성자
	public InterviewDTO(int interviewId, LocalDateTime requestedDate, String interviewCategory, String interviewNote,
	...
	public InterviewDTO(int interviewId, LocalDateTime requestedDate, String interviewCategory, String interviewNote, String interviewStatus, String isCompleted, int studentId, int professorId) {
		this.interviewId = interviewId;
		this.requestedDate = requestedDate;
		this.interviewCategory = interviewCategory;
		this.interviewNote = interviewNote;
	...
	public InterviewDTO(int interviewId, LocalDateTime requestedDate,int professorId, int studentId, String professorName) {
		this.interviewId = interviewId;
		this.requestedDate = requestedDate;
		this.studentId = studentId;
		this.professorId = professorId;
	...
	public InterviewDTO(int interviewId, LocalDateTime requestedDate, int studentId, String studentName,int professorId) {
		this.interviewId = interviewId;
		this.requestedDate = requestedDate;
		this.studentId = studentId;
